...
const { help } = require('./menubot/help')
const {help1} = require('./menubot/help1')
const {help2} = require('./menubot/help2')
const {help3} = require('./menubot/help3')
const {help4} = require('./menubot/help4')
const {help5} = require('./menubot/help5')
const {help6} = require('./menubot/help6')
const {help7} = require('./menubot/help7')
const {help8} = require('./menubot/help8')
const {help9} = require('./menubot/help9')
const {help10} = require('./menubot/help10')
var jogadas = 0; var isMuteAll = 0; var oneImage = 0; var oneLink = 0; var oneTrava = 0
const {ajuda} = require('./menubot/ajuda')
...
break
               case 'menu1':
                client.sendMessage(from, help1(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS INTERATIVOS", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
             break
				case 'help2':
				case 'menu2':
					client.sendMessage(from, help2(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "BEM VINDO AO MENU DE FIGURINHAS", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help3':
				case 'menu3':
					client.sendMessage(from, help3(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "BEM VINDO AO MENU DE MÚSICAS", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help4':
				case 'menu4':
					client.sendMessage(from, help4(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS ALEATÓRIOS", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help5':
				case 'menu5':
					client.sendMessage(from, help5(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS ON/OFF ", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help6':
				case 'menu6':
					client.sendMessage(from, help6(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS PARA GRUPOS ", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help7':
				case 'menu7':
					client.sendMessage(from, help7(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS PREMIUM 🎖️ ", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help8':
				case 'menu8':
					client.sendMessage(from, help8(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "NOVOS COMANDOS 🤠", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help9':
				case 'menu9':
					client.sendMessage(from, help9(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "COMANDOS EM TESTE ⚙️", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'help10':
				case 'menu10':
					client.sendMessage(from, help10(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "SOBRE O BOT 🤖", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
               case 'ajuda':
					client.sendMessage(from, ajuda(pushname, prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "MENU DE AJUDAS", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
               break
					case 'bot':
            if (isOwner) {
			...
			case 'aiai':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/aiai.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'cone':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/cone.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'menu':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audsmenu/menu.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'menu2':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audsmenu/menu2.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'jovemd':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/jovemd.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'medicine':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/medicine.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
                    case 'hilux':
                    client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/hilux.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
           case 'antiporn':
			if (isgroupMembers && isGroupAdmins || isGroupMsg && isOwner) {
				...
				if (args[0] == 'on') {
					...
					atporn.push(groupId)
					await fs.writeFileSync('./commands/antiporn.json', JSON.stringify(atporn))
					await kill.reply(from, mess.enabled(), id)
				} else if (args[0] == 'off') {
			...
			if (isMedia && isVideo || isGif || isQuotedVideo || isQuotedGif) {
				...
				await kill.sendMp4AsSticker(from, mediaData, null, { stickerMetadata: true, pack: config.pack, author: config.author, fps: 30, crop: true, loop: 0 }).catch(async () => { await kill.reply(from, mess.gifail(), id) })
...
//@muriooo.mp4					
			...
			if (isGroupMsg && isGroupAdmins || isGroupMsg && isOwner) {
				...
				if (args[0] == 'on') {
					...
					atstk.push(groupId)
					await fs.writeFileSync('./commands/sticker.json', JSON.stringify(atstk))
					await kill.reply(from, mess.enabled(), id)
				} else if (args[0] == 'off') {
...
break
		        ...
		        case 'gay':		
					...
					const ti =['4','9','17','28','34','48','59','62','74','83','97','100','29','94','75','82','41','39']
					const kl = ti[Math.floor(Math.random() * ti.length)]
					client.sendMessage(from, 'Como você é gostoso 😳: *'+rate+'*\n\nSua porcentagem gostoso: '+ kl+'%', text, { quoted: mek })
					break
					case 'hetero':		
	            	if (args.length < 1) return reply('marque seus amigos!')
					rate = body.slice(1)
					const ti =['4','9','17','28','34','48','59','62','74','83','97','100','29','94','75','82','41','39']
					const kl = ti[Math.floor(Math.random() * ti.length)]
					client.sendMessage(from, 'Como você é hetero: *'+rate+'*\n\nSua porcentagem heterossexual : '+ kl+'%', text, { quoted: mek })
					break
			...
			reply(mess.wait)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ ➣𝑴𝑼𝑹𝑰𝑳𝑶𝑶 𝑩𝑶𝑻, 𝑨𝑽𝑰𝑺𝑶 ]\n\n${body.slice(4)}`})
						}
